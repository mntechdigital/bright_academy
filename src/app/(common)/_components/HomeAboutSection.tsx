...
import aboutImage from "../../../../public/Union__2_.png";
    ...
    <section className="w-full bg-white py-16 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="relative flex items-center justify-center min-h-120">
          ...
          {/* Main image */}
          <div className="relative z-20 w-full max-w-sm rounded-3xl overflow-hidden shadow-xl mx-auto">
            <Image
              src={aboutImage}
        ...
        <div className="flex flex-col gap-6">
          ...
          <div
            ...
            style={{ border: "1px solid #f3f4f6", borderLeft: "4px solid #fb923c" }}
          >
            ...
            <div className="flex flex-col gap-1.5">
              <div className="flex items-center gap-3">
                <h3 className="text-base font-bold text-gray-900">আমাদের লক্ষ্য</h3>
                <div className="flex-1 h-px bg-gray-200" />
              </div>
              <p className="text-sm text-gray-600 leading-relaxed">
                ব্রাইট একাডেমির মূল লক্ষ্য হলো প্রতিটি শিক্ষার্থীর সুপ্ত প্রতিভা বিকশিত করা এবং তাদের একাডেমিক ও ব্যক্তিত্ব উন্নয়নে সহায়তা করা। আমরা বিশ্বাস করি যে প্রতিটি শিশুর মধ্যে অসীম সম্ভাবনা রয়েছে।
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex flex-col gap-3 w-full">
              <div className="flex items-center gap-3">
                <h3 className="text-base font-bold text-gray-900">আমাদের বিশেষত্ব</h3>
                <div className="flex-1 h-px bg-gray-200" />
              </div>
