      ...
      >
        ...
        <div className="flex gap-4">
          <button
            ...
            className="flex-1 py-3 rounded-lg border border-gray-300 bg-white text-gray-800 text-sm font-semibold hover:bg-gray-50 active:scale-95 transition-all"
          >
            Cancel
          </button>
          <button
            onClick={handleLogin}
            className="flex-1 py-3 rounded-lg bg-orange-500 hover:bg-orange-600 active:scale-95 text-white text-sm font-semibold transition-all"
          >
            Log In
          </button>
        </div>
